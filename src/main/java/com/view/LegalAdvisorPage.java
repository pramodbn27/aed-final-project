...
@Controller(value = "LegalAdvisorPage")
public class LegalAdvisorPage extends javax.swing.JFrame {
     ...
     */
    public LegalAdvisorPage(PrisonPatientDiagnoseRepository diagnoseRepository,
            PatientRepositoryPrison patientRepository,
            PrisonPatientVitalRepository patientVitalRepository,
    ...
    private void initComponents() {
        ...
        sendPolNtf = new javax.swing.JButton();
        txtName = new javax.swing.JTextField();
        txtId = new javax.swing.JTextField();
        txtComments = new javax.swing.JTextField();
        nameLb = new javax.swing.JLabel();
        LegalCommentsLb = new javax.swing.JLabel();
        ...
        tblPatient.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PATIENT ID", "NAME", "PRESCRIPTION", "PATIENT STATUS"
            }
        ));
        ...
        sendPolNtf.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        sendPolNtf.setText("SEND TO POLICE");
        sendPolNtf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sendPolNtfActionPerformed(evt);
            }
        });
        getContentPane().add(sendPolNtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 630, 280, 60));

        txtName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 480, 280, 50));

        txtId.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        getContentPane().add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 420, 280, 50));
        ...
        getContentPane().add(txtComments, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 540, 280, 50));

        nameLb.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        nameLb.setText("Name");
        getContentPane().add(nameLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 490, 110, 40));

        LegalCommentsLb.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        LegalCommentsLb.setText("Comments");
        getContentPane().add(LegalCommentsLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, 110, 40));

        patientIdLb.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        patientIdLb.setText("Id");
        getContentPane().add(patientIdLb, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 420, 110, 40));
        ...
        getContentPane().add(reloadBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 410, 80, -1));
    ...
    private void sendPolNtfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendPolNtfActionPerformed
        DefaultTableModel model = (DefaultTableModel) tblPatient.getModel();
        if (model.getRowCount() != 0) {
            String id = model.getValueAt(tblPatient.getSelectedRow(), 0).toString();
            PrisonPatientEntity finddetailById = patientRepository.finddetailById(Integer.parseInt(id));
            if (null != finddetailById) {
                finddetailById.setStatus("Sent to Police");
                PrisonPatientDiagnoseEntity finddetailById1 = diagnoseRepository.finddetailById(finddetailById.getId());
                finddetailById1.setCommelegalAdvisorComments(txtComments.getText());
                diagnoseRepository.save(finddetailById1);
                patientRepository.save(finddetailById);
                loadPatients();
                JOptionPane.showMessageDialog(this, "Notified Police about the Case !!");
            }
        }
    }//GEN-LAST:event_sendPolNtfActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LegalAdvisorPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel LegalCommentsLb;
    ...
    private javax.swing.JButton sendPolNtf;
...
private void loadPatients() {
        ...
        for (PrisonPatientEntity entity : findAll) {
            if (entity.getStatus().equals("Sent to Legal Advisor")) {
                ...
                if (null != finddetailById) {
                    Object[] data = {entity.getId(),
                        entity.getName(), diagnoseEntity.getComments(),
                        entity.getStatus()};
