...
public class PharmacyPage extends javax.swing.JFrame {
     ...
     */
    public PharmacyPage(PatientDiagnoseRepository diagnoseRepository,
            PatientRepository patientRepository,
            PatientVitalRepository patientVitalRepository,
    ...
    private void initComponents() {
        ...
        dispatchMedicineBtn = new javax.swing.JButton();
        ...
        jLabel1.setText("VIEW PHARMACY PATIENTS");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 250, 40));
        ...
        dispatchMedicineBtn.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        dispatchMedicineBtn.setText("Dispatch Medicines");
        dispatchMedicineBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dispatchMedicineBtnActionPerformed(evt);
            }
        });
        getContentPane().add(dispatchMedicineBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 580, 280, 60));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 20, 200, 40));
    ...
    private void dispatchMedicineBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dispatchMedicineBtnActionPerformed
        ...
        if (model.getRowCount() != 0) {
            ...
            if (null != finddetailById) {
                finddetailById.setStatus("Dispatched");
                patientRepository.save(finddetailById);
                JOptionPane.showMessageDialog(this, "Dispatched Medicines");
                loadPatients();
                MailUtils.sendEmail("ajitp4292@gmail.com", "Dispatched Medicines!!", "Dispatched Medicines");

            }
        }
    }//GEN-LAST:event_dispatchMedicineBtnActionPerformed
    ...
    private javax.swing.JButton dispatchMedicineBtn;
...
private void loadPatients() {
        ...
        for (PatientEntity entity : findAll) {
            if (entity.getStatus().equals("Sent to Pharmacy")) {
                ...
                if (null != finddetailById && diagnoseEntity != null) {
